...
#[global] Remove Hints Equivalence_Reflexive
  equiv_reflexive
...
#[global] Hint Extern 0 (Reflexive _) => apply @Equivalence_Reflexive : typeclass_instances.
#[global] Hint Extern 0 (Symmetric _) => apply @Equivalence_Symmetric : typeclass_instances.
#[global] Hint Extern 0 (Transitive _) => apply @Equivalence_Transitive : typeclass_instances.
...
#[global] Hint Extern 0 (Transitive (<)) => apply @StrictOrder_Transitive : typeclass_instances.
#[global] Hint Extern 0 (Reflexive (≤)) => apply @PreOrder_Reflexive : typeclass_instances.
#[global] Hint Extern 0 (Transitive (≤)) => apply @PreOrder_Transitive : typeclass_instances.
*)
...
#[global] Instance equivalence_proper `{Equivalence A R} : Proper (R ==> R ==> iff) R | 0 := _.
