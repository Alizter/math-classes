...
Notation "(≪ n )" := (λ x, x ≪ n) (only parsing) : mc_scope.
#[global] Instance: Params (@shiftl) 3 := {}.
...
#[global] Instance: Params (@shiftr) 3 := {}.
...
#[global] Instance: Params (@div_euclid) 2 := {}.
#[global] Instance: Params (@mod_euclid) 2 := {}.
...
#[global] Instance: Params (@cut_minus) 2 := {}.
